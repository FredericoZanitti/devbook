...
// BuscarPorID trás um usuário do BD
...
// Alterar altera um usuário no banco
...
// Deletar exclui um usuário no banco
...
// BuscarPorEmail busca usuario por email e retorna seu id e hash
